...
public class NegativeTest {
    ...
    @Test
    public void FailIncorrectNameInput() {
        driver.findElement(By.xpath("//span[@data-test-id='name']//input")).sendKeys("Anton");
        driver.findElement(By.xpath("//span[@data-test-id='phone']//input")).sendKeys("+78431253535");
    ...
    public void FailEmptyNameInput() {
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+78431253535");
    ...
    @Test
    public void FailIncorrectPhoneInput() {
        driver.findElement(By.xpath("//span[@data-test-id='name']//input")).sendKeys("Антон");
        driver.findElement(By.xpath("//span[@data-test-id='phone']//input")).sendKeys("sadasd");
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.cssSelector("button.button")).click();
    }
